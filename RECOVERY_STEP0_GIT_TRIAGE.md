...
2. Apply one canonical gate definition across:
- v2/run_v2_rebuild.py
- v2 scorecard CSVs
- narrative docs

3. Perform structural cleanup only after notebook decision.
