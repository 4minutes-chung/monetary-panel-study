...
\section*{1. Data Engineering \& Workflow}

The construction of the unbalanced panel involved merging raw World Bank WDI variables and managing severe country-specific data irregularities. This project prioritizes descriptive reliability over sample size maximization. Key data governance decisions included:
...
\begin{itemize}
    ...
    \item \textbf{Unit Break Correction:} The raw WDI data contained a spurious $-680\%$ M2 growth rate for Sierra Leone in 2015. Investigation revealed this was a reporting/redenomination artifact (the M2/GDP level series dropped from $\sim$13,000 to $\sim$15). This observation was explicitly scrubbed via standard \texttt{dropna} handling.
\end{itemize}
