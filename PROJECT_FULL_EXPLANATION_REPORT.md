...
- Reproducible notebooks and export pipelines.
...
## 8. Related files already generated
Main notebooks:
- `lucas_Phase 1.ipynb`
- `lucas_Phase 1.1.ipynb`
- `lucas_Phase 1.audit.ipynb`
...
Interview one-pager:
- `outputs/phase1_audit/phase1_audit_interview_onepager.md`
